...
//                CommonTask.showAlert(Alert.AlertType.WARNING, "Error", "Field Can't be Empty!");
                ...
                if (resultSet.next()) {
                    ...
                    CommonTask.pageNavigation("/sample/customer/CustomerPages/UserMain.fxml", Main.stage, this.getClass(), "User Dashboard", 1750, 900);
                } else {
    ...
    public void UserSignup(ActionEvent mouseEvent) throws IOException {
        CommonTask.pageNavigation("UserSignup.fxml", Main.stage ,this.getClass(),"User Signup", 1750, 900);
    }
@FXML
    public void BackToMain(ActionEvent mouseEvent) throws IOException {
        CommonTask.pageNavigation("/sample/sample.fxml", Main.stage,this.getClass(),"Hotel Management System", 1750, 900);
    }
