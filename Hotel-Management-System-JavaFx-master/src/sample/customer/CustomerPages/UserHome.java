...
public class UserHome implements Initializable {
    ...
    public void BackToLoginPage(ActionEvent actionEvent) throws IOException {
        CommonTask.pageNavigation("/sample/sample.fxml", Main.stage,this.getClass(),"User Home", 1750, 900);
        welcomed = 0;
    }

    public void UserInfo(ActionEvent actionEvent) throws IOException {
        CommonTask.pageNavigation("/sample/customer/CustomerPages/CustomerInfo/UserInfo.fxml", null,this.getClass(),"User Home", 1750, 900);
    }
