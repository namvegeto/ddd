...
public class Controller implements Initializable{
    ...
    void Customer_Login(ActionEvent event) throws IOException {
        CommonTask.pageNavigation("customer/Login/UserLogin.fxml",Main.stage,this.getClass(),"Customer Login", 1750, 900);
    }

    @FXML
    void Manager_Login(ActionEvent event) throws IOException {
        CommonTask.pageNavigation("manager/Login/ManagerLogin.fxml",Main.stage,this.getClass(),"Manager Login", 1750, 900);
    }

    @FXML
    void Admin_Login(ActionEvent event) throws IOException {
        CommonTask.pageNavigation("zadmin/Login/AdminLogin.fxml", Main.stage,this.getClass(),"Admin Login", 1750, 900);
    }
